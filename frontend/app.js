   ...
   // const editTasksBtn = document.getElementById("editTasks");
    ...
    function editList(element, type) {
        ...
        if (listItems.length === 0) {
            console.error("No items found in the list to edit.");
            return;
        }
        ...
        let saveBtn = element.querySelector(".save-btn");
        ...
        if (!saveBtn) {
            ...
            saveBtn.addEventListener("click", () => {
                ...
                const updatedItems = Array.from(listItems).map((li) => li.innerText.trim());

                if (type === "tasks") {
                    meetingDetails.tasks = updatedItems;
                } else if (type === "keyPoints") {
                    meetingDetails.keyPoints = updatedItems;
                }
    ...
    if (editTasksBtn) {
        ...
        console.error("Edit Tasks button not found.");
    }

    if (editKeyPointsBtn) {
        editKeyPointsBtn.addEventListener("click", () => editList(keyPointsList, "keyPoints"));
    } else {
        console.error("Edit Key Points button not found.");
    }
});
